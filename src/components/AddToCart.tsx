  ...
  if (variant === 'icon') {
    return (
      <button
        ...
        title={t('addToCart')}
        className="absolute bottom-3 right-3 z-10 flex h-10 w-10 items-center justify-center rounded-full bg-black text-white shadow-[0_4px_16px_rgba(0,0,0,0.35)] transition-colors duration-200 hover:text-pink disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:text-white"
      >
