    ...
    <Container className="max-w-2xl py-32">
      ...
      <Card>
        ...
        <div className="mt-12 flex flex-wrap items-center justify-center gap-4">
          <Link
            href="/account"
            className="rounded-[20px] bg-olive px-8 py-4 font-display text-xl uppercase leading-none text-white transition-colors duration-200 hover:text-pink"
          >
            {t('viewAccount')}
          </Link>
          <Link
            href="/shop"
            className="font-display text-xl uppercase leading-none text-black underline underline-offset-4 transition-colors duration-200 hover:text-olive"
          >
            {t('backToShop')}
          </Link>
        </div>
