        ...
        <Card className="text-left">
          ...
          <form action="/api/checkout" method="post" className="mt-3">
            ...
            <button
              type="submit"
              disabled={!buyable}
              className="w-full rounded-[20px] border border-ink/25 px-8 py-4 font-display text-2xl uppercase leading-none text-ink transition-colors duration-200 hover:text-white disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:text-ink"
            >
