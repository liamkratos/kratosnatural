    ...
    <Container className="max-w-5xl py-24">
      <div className="grid gap-12 md:grid-cols-2 md:items-start">
        ...
        <Card className="text-left">
          ...
          <p className="mt-3 text-xl leading-snug text-black">
            {product.description}
          </p>
          ...
          <form action="/api/checkout" method="post" className="mt-3">
            ...
            <button
              type="submit"
              disabled={!buyable}
              className="w-full rounded-[20px] border border-ink/25 px-8 py-4 font-display text-2xl uppercase leading-none text-ink transition-colors duration-200 hover:text-olive disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:text-ink"
            >
