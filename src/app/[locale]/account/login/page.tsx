      ...
      <Card>
        ...
        >
          ...
          <input
            ...
            className="w-full rounded-[20px] border border-ink/25 bg-transparent py-3 pl-5 pr-32 text-center font-display text-lg uppercase text-ink placeholder:text-black focus:border-olive focus:outline-none"
          />
          <button
            type="submit"
